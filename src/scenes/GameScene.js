...
export default class GameScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.leftButton = this.add
      .sprite(50, canvasHeight - 50, 'leftButton')
      .setInteractive()
      .setScale(buttonScale);
    this.rightButton = this.add
      .sprite(150, canvasHeight - 50, 'rightButton')
      .setInteractive()
      .setScale(buttonScale);
    this.jumpButton = this.add
      .sprite(canvasWidth - 50, canvasHeight - 50, 'jumpButton')
      .setInteractive()
      .setScale(buttonScale);
    ...
    this.cheeseIcon = this.add
      .sprite(100, 25, 'cheese')
      .setScale(0.08)
      .setOrigin(0.5, 0.5);

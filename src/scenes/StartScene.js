export default class StartScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.background.setScale(Math.max(canvasWidth / this.background.width, canvasHeight / this.background.height));
        ...
        const startButton = this.add.text(canvasWidth / 2, canvasHeight / 2 + 150, 'Start', {
            fontSize: '48px',
